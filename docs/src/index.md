...
[![Citation](https://img.shields.io/badge/citation-BibTeX-778899)](https://github.com/JuliaFewBody/FewBody.jl/blob/main/CITATION.bib)
[![License](https://img.shields.io/github/license/JuliaFewBody/FewBody.jl)](https://github.com/JuliaFewBody/FewBody.jl/blob/main/LICENSE)
...
Use [CITATION.bib](https://github.com/JuliaFewBody/FewBody.jl/blob/main/CITATION.bib) to cite this package.

```@example
import FewBody # hide
println(read(joinpath(pkgdir(FewBody), "CITATION.bib"), String)) # hide
```

## Acknowledgments

This package is written in the [Julia programming language](https://julialang.org/), built on an initial project template generated using [PkgFactory.jl](https://github.com/ohno/PkgFactory.jl). This repository is hosted on [GitHub](https://github.com/JuliaFewBody/FewBody.jl), and continuous integration is run using [GitHub Actions](https://github.com/JuliaFewBody/FewBody.jl/actions).
